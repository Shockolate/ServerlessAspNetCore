...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *ServerlessAspNetCore*):

Restore dependencies
```
    cd "ServerlessAspNetCore"
    dotnet restore
```

Execute unit tests
```
    cd "ServerlessAspNetCore/test/ServerlessAspNetCore.Tests"
    dotnet test
```

Deploy application
```
    cd "ServerlessAspNetCore/src/ServerlessAspNetCore"
